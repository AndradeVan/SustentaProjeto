...
public class OrganizadorActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*fazer tudo dentro do click do botao*/
        nome = findViewById(R.id.editOrgaNome);
        categoria = findViewById(R.id.editOrgcat);
        ...
        bntSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*passar para o firebase*/
                databaseReference.child("Jogador").child(jogador.getCategoria()).setValue(jogador);
                limparcampo();

                /*buscar e verificar se tem chave primaria igual*/
            }
        });
    ...
    private void inicializarFirebase() {
        FirebaseApp.initializeApp((OrganizadorActivity.this));
